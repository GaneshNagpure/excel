...
#     fig_instruments.savefig(buffer_instruments, format='png')
...
#     fig_industries.savefig(buffer_industries, format='png')
...
#     # Plot bar graph for top 5 industries by investment (horizontal bar chart)
#     labels_industries_bar = [x['industry'] for x in top_industries]
#     values_industries_bar = [x['investment'] for x in top_industries]

#     fig_industries_bar, ax_industries_bar = plt.subplots()
#     ax_industries_bar.barh(labels_industries_bar, values_industries_bar)
#     ax_industries_bar.set_xlabel('Investment (in Lakhs)')
#     ax_industries_bar.set_title('Top 5 Industries by Investment')
...
#     buffer_industries_bar = io.BytesIO()
#     fig_industries_bar.savefig(buffer_industries_bar, format='png', transparent=True)
#     buffer_industries_bar.seek(0)
#     img_industries_bar = base64.b64encode(buffer_industries_bar.getvalue()).decode('utf-8')
...
#         'img_instruments': img_instruments,
#         'img_industries': img_industries,
#         'img_industries_bar': img_industries_bar,
#     })
...
def upload_excel(request):
    ...
    # Plot horizontal bar chart for Equity, Debt, and Others
    categories = ['Equity', 'Debt', 'Others']
    values = [equity_total, debt_total, combined_others_total]

    fig_bar, ax_bar = plt.subplots()
    ax_bar.barh(categories, values, color=['green', 'blue', 'orange'])
    ax_bar.set_xlabel('Market Value (in Lakhs)')
    ax_bar.set_title('Market Value Breakdown by Category')
    ...
    return render(request, 'upload_result.html', {
        ...
        'img_instruments': img_instruments,
        'img_industries': img_industries,
        'img_bar': img_bar,  # Include the bar chart
    })
